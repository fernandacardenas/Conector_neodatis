...
public class Rentar extends javax.swing.JFrame {
    ...
    public Rentar(int id) {

        ODB odb = ODBFactory.open("DATOS_PELICULAS.DB");
        IQuery consultotas = new CriteriaQuery(Modelo.CSocios.class, Where.equal("ID", id));
    ...
    private void initComponents() {
        ...
        cbx_socio = new javax.swing.JComboBox<>();
        ...
        cbx_socio.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/shopping-add.png"))); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(cbx_socio, javax.swing.GroupLayout.Alignment.LEADING, 0, 89, Short.MAX_VALUE)
                                .addComponent(txt_IDrenta, javax.swing.GroupLayout.Alignment.LEADING))
                            .addComponent(cbxejemplar, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(84, 84, 84)
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cbxpelinom, 0, 458, Short.MAX_VALUE)))
                .addGap(41, 41, 41))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(cbx_socio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(19, 19, 19)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        /* int id_venta = Integer.parseInt(txt_IDrenta.getText());
        int id_cliente = Integer.parseInt(txt_IDsocio.getText());
        int id_producto = Integer.parseInt(txt_IDpeli.getText());
        int cantidad = Integer.parseInt(txt_CTD.getText());
        String fecha = txt_fecha.getText();

        Modelo.CRentas ve = new Modelo.CRentas(id_venta, id_cliente, id_producto, cantidad, fecha);
        op.insertar(ve);*/
        //JOptionPane.showMessageDialog(null,"Insertado en neodatis");
    ...
    private javax.swing.JComboBox<String> cbx_socio;
